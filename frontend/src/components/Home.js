	...
	render() {
		return (
			<div>
				...
				<div className="content" data-aos="fade-down" data-aos-duration="600">
					<div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
					  ...
					  <div className="carousel-inner">
									...
									<div className="col-sm-8">
										<a className="btn expert btn-outline-white">
											<div className="card-title">
												<h5 style={{color: "black"}}>Attend Classes Anywhere at your confortable time</h5>
											</div>
										</a>
									</div>
					    	...
					    	<div className="carousel-caption d-md-block">
							    <div className="row laga">
									<div className="col-sm-6">
										<img className="img-fluid" width="300" src={"/static/frontend/teacher.svg"} />
									</div>
									<div className="col-sm-6 scene2" style={{margin:"auto"}}>
										<a className="btn expert btn-outline-white">
											<div className="card-title">
												<h5 style={{color: "black"}}>Expert Faculty</h5>
											</div>
										</a>
									</div>
								</div>
					    ...
					    <div className="carousel-item">
					    	...
					    	<div className="carousel-caption d-md-block">
					    		<div className="row laga">
					    			<div className="col-sm-6 u">
								    	<a className="btn expert btn-outline-white">
											<div className="card-title">
												<h5 style={{color: "black"}}>One to One interaction</h5>
											</div>
										</a>
					    			</div>
						    		<div className="col-sm-6">
								    	<img className="img-fluid" src={"/static/frontend/interaction.png"} width="300" alt="" />
					    			</div>
					    		</div>
							</div>
				...
				<div className="section2 bg-bitblue">
					...
					<div className="cus_container text-left card p-5" data-aos="fade-up" data-aos-duration="1000">
