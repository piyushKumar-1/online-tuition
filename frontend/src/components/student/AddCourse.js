...
class AddCourse extends React.Component {
    ...
    makeSelected = (e) => {
    	...
    	if(e.target.classList.contains('selected')){
	    	...
	    	this.setState({'selectedCourseId': e.target.id});
    ...
    postIt(){
    	this.props.addCourse(this.state.selectedCourseId);
    }
    					...
    					<div className="col-sm-6 mt-3">
							<div className="box">
	    						<div className="main card">
	        						...
	        						<div  onClick={this.makeSelected} className="overlay m-auto text-center p-4" id={j}>
									</div>
		...
		return (
			...
			<Sidebar /> 
				<div className="container top-300">
				    ...
				    <div className="mt-5">
				    	<button onClick={this.postIt}></button>
				    </div>
			    </div>
			</div>
...
export default connect(mapStateToProps, { getSubCourses, getCourses, addCourse })(AddCourse);