 ...
 document.title = "Our Practices | Learnerz Corner"
  window.scrollTo(0, 0)
	...
	render() {
		return (
			<div>
				<div className="container mt-5 mb-5" data-aos="zoom-in-down" data-aos-duration="1200">
					<div className="row mt-5 mb-5" data-aos="zoom-in-down" data-aos-duration="1200">
